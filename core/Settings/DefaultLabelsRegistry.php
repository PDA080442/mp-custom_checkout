	...
	public static function all(): array {
		return array(
			...
			'step_4' => array(
				...
				'address_error_postcode_format' => 'Введите 6 цифр почтового индекса.',
				'address_error_postcode_unavailable' => 'Доставка Почтой России по этому индексу недоступна. Проверьте индекс или выберите другой способ доставки.',
				'postcode_checking_hint' => 'Проверяем индекс…',
				'post_russia_price_notice' => 'Точная цена доставки Почтой России рассчитается после ввода почтового индекса в полях адреса ниже.',
